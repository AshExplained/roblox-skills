# Roblox Skills for Claude Code — 34 AI Skills for Roblox Game Development

> A curated pack of **Claude Code / Claude Agent skills** covering the full **Roblox game development lifecycle** — from game ideas and Luau architecture to monetization, retention, live ops, security, and Roblox Studio MCP workflows.

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Skills](https://img.shields.io/badge/skills-34-blue.svg)](#skill-catalog)
